import{b6 as G,aZ as j,b7 as Z,b8 as J,b9 as F,ba as S,bb as X,b5 as K,bc as W,bd as tt,be as et,bf as nt,bg as ot,bh as it,bi as at}from"./index-fQYeFid-.js";import{f as st}from"./functions-DA3zLneW.js";import{p as dt}from"./printHtmlDocument-D8OCIf4C.js";import{c as rt}from"./code128Barcode-D2KDP90S.js";const M="[CAJA_POS]",lt="[CONTADO]",Q="[CREDITO]";function Tt({baseNote:t,saleType:e}){const o=e==="credito"?Q:lt,r=String(t||"").replace(/\[CAJA_POS\]/g,"").replace(/\[CONTADO\]/g,"").replace(/\[CREDITO\]/g,"").replace(/\s+/g," ").trim();return`${M} ${o} ${r}`.trim()}function ut(t){if(!t)return"—";const e=String(t.notes||""),o=t.customer,r=String((o==null?void 0:o.name)||"").trim();if(!e.includes(M))return r||"—";const l=e.toLowerCase();return l.includes("mostrador")||l.includes("consumidor final")||l.includes("sin datos de cliente")?"Consumidor Final":r||"—"}function ct(t){const e=String((t==null?void 0:t.notes)||"");return!(!e.includes(M)||e.includes(Q)||String((t==null?void 0:t.paymentMethod)||"").toLowerCase()==="credito")}function Nt(t){return!ct(t)}function At(t){return t.find(e=>{const o=String(e.name||"").toLowerCase();return o.includes("consumidor")||o.includes("final")})??null}function y(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function p(t,e,o=!1){return`<div style="margin:0 0 3px;line-height:1.3">
    ...
    <span style="font-weight:${o?800:600};word-break:break-all">${y(e||"—")}</span>
      ...
      </div>`).join(""),m=(f=t.fiscal)!=null&&f.fromSettingsPreview?'<div style="margin-top:6px;font-size:10px;font-weight:700;color:#444">Sin factura SRI vinculada: el Nº se asigna al emitir/autorizar.</div>':"";return`${d}${m}`}function U(t,e){const o=ot(t.paymentMethod);return`<div style="font-size:0.9em">
  ...
  </div>`,N=J(d,m,e),R={money:S,unitPrice:X,description:(c,z)=>W(c,d,z,m)},C=N.map(c=>`${Math.max(.4,c.widthPct/12)}fr`).join(" "),u=l?`<div style="margin-bottom:8px">
  ...
  </div>`}const b=t=>Number(Number(t||0).toFixed(2)),O=t=>Number(Number(t||0).toFixed(3)),pt={factura:"Factura",nota_venta:"Nota de venta",documento:"Comprobante",consumidor_final:"Consumidor final"},wt=[{value:"factura",label:"Factura"},{value:"nota_venta",label:"Nota de venta"},{value:"documento",label:"Comprobante"},{value:"consumidor_final",label:"Consumidor final"}];function L(t){return pt[t]||t||"—"}function k(t){switch(t){case"factura":return"FACTURA";case"nota_venta":return"NOTA DE VENTA";case"consumidor_final":return"CONSUMIDOR FINAL";default:return"COMPROBANTE DE VENTA"}}function Ct(t,e){if(!t)return null;const o=e||t.documentType||"documento",r=t._customerRaw||{};if(o==="consumidor_final")return{...t,documentType:o,documentTypeLabel:L(o),documentTitle:k(o),customerName:"Consumidor Final",customerPhone:"",customerAddress:"",customerEmail:"",customerCedula:""};const l=String(r.name||"").trim()||(t.customerName&&t.customerName!=="Consumidor Final"?t.customerName:"")||"—";return{...t,documentType:o,documentTypeLabel:L(o),documentTitle:k(o),customerName:l,customerPhone:r.phone||t.customerPhone||"",customerAddress:r.address||t.customerAddress||"",customerEmail:r.email||t.customerEmail||"",customerCedula:r.cedula||t.customerCedula||""}}function zt(t,e){return t==="factura"?"factura":t==="nota_venta"?"nota_venta":e?"documento":"consumidor_final"}function _(t){return`$${b(t).toFixed(2)}`}function gt(t){const e=O(t),o=Math.round(e*100)===e*100?2:3;return`$${e.toFixed(o)}`}function bt(t){return st(t)}const I={name:"Nom:",cedula:"CI:",phone:"Tel:",address:"Dir:",payment:"Pag:"};function ft(t){const e=String(t||"").toLowerCase();return e==="efectivo"?"Efectivo":e==="transferencia"?"Transferencia":e==="tarjeta"?"Tarjeta":e==="credito"?"Crédito":t||"—"}function Y(t){if(!t)return null;const e=(t.items||[]).map(i=>({name:i.name||i.productName||"Producto",code:i.code||i.sku||i.barcode||"",barcode:i.barcode||i.code||i.sku||"",unitLabel:i.unitLabel||i.unit||"",productId:i.productId||i.id||null,quantity:Number(i.quantity||0),price:O(i.price),discount:b(i.discount||0),lineTotal:b(i.lineTotal??Number(i.quantity)*Number(i.price)),taxRate:Number(i.taxRate||0),subtotal:b(i.subtotal??i.lineTotal),iva:b(i.iva||0)})),o=b(t.subtotal??e.reduce((i,g)=>i+g.subtotal,0)),r=b(t.iva??e.reduce((i,g)=>i+g.iva,0)),l=b(t.total??e.reduce((i,g)=>i+g.lineTotal,0)),n=b(t.discount??e.reduce((i,g)=>i+Number(g.discount||0),0)),s=t.customer||{},d=t.documentType||"documento",m=ut({notes:t.notes||"",customer:s}),f=String(s.name||"").trim()||(m&&m!=="Consumidor Final"?m:""),v=d==="consumidor_final"?"Consumidor Final":f||m||s.name||"—",$=j();return{id:t.id,businessName:$.alias||"App",businessDescription:$.description||"",logoUrl:$.logoUrl||"",documentTitle:k(d),documentType:d,documentTypeLabel:L(d),date:bt(t.date||t.paidAt),dateIso:t.date||t.paidAt||null,customerName:v,customerPhone:s.phone||"",customerAddress:s.address||"",customerEmail:s.email||"",customerCedula:s.cedula||"",_customerRaw:{name:f,phone:s.phone||"",address:s.address||"",email:s.email||"",cedula:s.cedula||""},paymentMethod:ft(t.paymentMethod),items:e,subtotal:o,iva:r,total:l,discount:n,ticketDiscountPercent:Number(t.ticketDiscountPercent||0),notes:String(t.notes||"").replace(/\[CAJA_POS\]/g,"").replace(/\[CONTADO\]/g,"").replace(/\[CREDITO\]/g,"").trim()}}function Rt(t){if(!t)return null;const o=(t.ERP_order_items||t.items||[]).map(d=>{var a;const m=Number(d.quantity||0),f=O(d.price),v=b(m*f),$=Number(((a=d.ERP_inventory_product)==null?void 0:a.taxRate)||d.taxRate||0);let i=v,g=0;$>0&&(i=b(v/(1+$/100)),g=b(v-i));const x=d.ERP_inventory_product||{};return{name:x.name||d.name||"Producto",code:x.sku||x.barcode||d.code||"",barcode:x.barcode||x.sku||d.code||"",unitLabel:x.unitLabel||x.unit||d.unitLabel||"",productId:d.productId||x.id||null,quantity:m,price:f,discount:0,taxRate:$,subtotal:i,iva:g,lineTotal:v}}),r=o.reduce((d,m)=>d+m.subtotal,0),l=o.reduce((d,m)=>d+m.iva,0),n=o.reduce((d,m)=>d+m.lineTotal,0),s=t.ERP_customer||t.customer||{};return Y({id:t.id,date:t.date,paidAt:t.paidAt,paymentMethod:t.paymentMethod||"credito",documentType:t.documentType||"nota_venta",notes:t.notes,customer:s,items:o,subtotal:r,iva:l,total:n})}function St({orderId:t,cart:e,customer:o,documentType:r,paymentMethod:l,saleType:n,notes:s,ticketDiscountPercent:d=0,discountTotal:m=0}){const f=e.map(a=>{const h=Number(a.quantity||0),D=O(a.price),N=a.lineTotal!=null&&Number.isFinite(Number(a.lineTotal))?b(a.lineTotal):b(h*D),R=Number(a.taxRate||0);let C=a.subtotal!=null&&Number.isFinite(Number(a.subtotal))?b(a.subtotal):N,u=a.iva!=null&&Number.isFinite(Number(a.iva))?b(a.iva):0;return a.subtotal==null&&R>0&&(C=b(N/(1+R/100)),u=b(N-C)),{name:a.name,code:a.sku||a.barcode||a.code||"",barcode:a.barcode||a.sku||a.code||"",unitLabel:a.unitLabel||a.unit||"",productId:a.productId||a.id||null,quantity:h,price:D,discount:b(a.discount||0),discountPercent:Number(a.discountPercent||0),taxRate:R,subtotal:C,iva:u,lineTotal:N}}),v=f.reduce((a,h)=>a+h.subtotal,0),$=f.reduce((a,h)=>a+h.iva,0),i=f.reduce((a,h)=>a+h.lineTotal,0),g=m>0?b(m):b(f.reduce((a,h)=>a+Number(h.discount||0),0)),x=r;return Y({id:t,date:new Date().toISOString(),paidAt:n==="credito"?null:new Date().toISOString(),paymentMethod:n==="credito"?"credito":l,documentType:x,notes:s,customer:o,items:f,subtotal:v,iva:$,total:i,discount:g,ticketDiscountPercent:Number(d||0)})}function Pt(t,e,o={}){const r=it(t)?mt(t,e,o):xt(t,e,o);dt(r,{format:e})}function xt(t,e,o={}){var C;const{showNotes:r=!0}=o,l=K(e),n=l.isTicket,s=l.print,d=n?"100%":"210mm",m=n?s.fs:"14px",f=n?"0":"24px",v=(u,T,P=!1)=>{const c=P?"font-weight:800;":"font-weight:700;",z=P?n?`font-size:${s.totalBold}px;`:"font-size:17px;":"";return`<div style="display:table;width:100%;${c}${z}">
    ...
    ${$}
  </div>`}function A(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}export{wt as D,I as R,Ct as a,Rt as b,Pt as c,gt as d,At as e,_ as f,Tt as g,St as h,Nt as i,L as j,bt as k,Y as n,ft as p,zt as r};
